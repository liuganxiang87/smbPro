...
export class OneComponent implements OnInit {
  ...
  constructor(private msg: NzMessageService, private service: FormTaskFlowTreeService, private router: Router, private myhttp: NghttpService, private activatedRoute: ActivatedRoute, private modal: NzModalService, private progressFun: ProgressFunWrapService) {
    let that = this;
  ...
  ngOnInit() {
    console.log('初始化------------------------------------------------', this.createForm)
  }
